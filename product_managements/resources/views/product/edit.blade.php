        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('product.update', $aProducts->id) }}" method="POST" class="forms-sample"
                        ...
                        <a style="float:right;" title="Cancel" href="{{ route('product.index') }}"
