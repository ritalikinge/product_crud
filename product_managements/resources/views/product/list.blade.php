...
@section('content')
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                ...
                @endif
                    ...
                    <a style="float:right;" title="Add Module" href="{{ route('product.create') }}"
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('product.destroy', $val->id) }}" method="POST">
                                                    ...
                                                    <a href="{{ route('product.edit', $val->id) }}" title="Edit"><i
                                ...
                                @else
                                    <tr>
                                        <td colspan="4" style="text-align:center; color:red;"> Data not found </td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
    ...
    <!----row--->
    <div class="modal fade text-start" id="large" tabindex="-1" aria-labelledby="myModalLabel17" aria-hidden="true"> </div>
@endsection
